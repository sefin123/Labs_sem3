...
void MainWindow::createDrawActionGruop()
{
    ...
    QAction *lineAct = new QAction(QIcon("D:/qt projects/paintCourse/icons/ColorPicker.ico"), "&ColorPicker");
    connect(lineAct, SIGNAL(triggered()), _workingSpace, SLOT(setColorPicker()));
